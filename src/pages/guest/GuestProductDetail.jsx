...
export function GuestProductDetail({ products = [] }) {
  ...
  const img = PRODUCT_IMAGES[product.name] || product.image
          ...
          <div style={{ flex: '1 1 320px' }}>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <div style={{
                  width: 60, height: 44, display: 'flex', alignItems: 'center', justifyContent: 'center',
                  border: `1px solid ${t.border}`, borderLeft: 'none', borderRight: 'none',
                  background: t.bg, fontSize: 16, fontWeight: 900, color: t.text,
                }}>{qty}</div>
