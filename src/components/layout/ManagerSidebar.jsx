...
const managerNav = [
  ...
  { key: 'returns', l: 'Returns & Refunds', i: 'RotateCcw' },
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '24px 20px', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div className="sidebar-label">
            <div style={{ fontSize: 16, fontWeight: 700, letterSpacing: -0.3 }}>Manager Pro</div>
        ...
        {managerNav.map((item, i) => {
          ...
          return (
            <button key={item.key} onClick={() => handleNav(item)} style={{
              ...
              cursor: 'pointer', textAlign: 'left', fontWeight: active ? 600 : 500, fontSize: 14,
      ...
      <div style={{ padding: '20px', borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
        <div className="sidebar-label" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: '16px', display: 'flex', alignItems: 'center', gap: 14, border: '1px solid rgba(255,255,255,0.05)', backdropFilter: 'blur(10px)' }}>
